...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    // Create particles - adjusted for light theme
    class Particle {
      constructor() {
        this.reset();
      }
      ...
      reset() {
        ...
        // Lighter, more subtle colors for light background
    ...
    // Initialize particles - fewer particles for light theme
    for (let i = 0; i < 60; i++) {
  ...
  return (
    <footer className="relative bg-gradient-to-t from-gray-50 via-white to-gray-50 text-gray-800 py-12 px-4 overflow-hidden border-t border-gray-200">
      {/* Canvas Background */}
      <canvas
        ref={canvasRef}
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-8">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-lg transition-colors duration-300"
          >
            <FaLinkedin /> LinkedIn
          </a>
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2 bg-orange-50 hover:bg-orange-100 text-orange-700 rounded-lg transition-colors duration-300"
          >
            <SiLeetcode /> LeetCode
          </a>
          <a 
            href="mailto:jiteshsolanki8990@gmail.com" 
            className="flex items-center gap-2 px-4 py-2 bg-red-50 hover:bg-red-100 text-red-700 rounded-lg transition-colors duration-300"
          >
            <FaEnvelope /> Email
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-10 md:mb-12">
          {/* Column 1 */}
          <div>
            <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4 flex items-center gap-2 text-gray-900">
          ...
          {/* Column 2 */}
          <div>
            <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4 text-gray-900">Quick Contact</h3>
            <div className="space-y-1 md:space-y-2">
              <p className="text-gray-600 hover:text-purple-600 transition-colors cursor-pointer text-sm md:text-base">
                ✉️ jiteshsolanki8990@gmail.com
              </p>
              <p className="text-gray-600 text-sm md:text-base">📍 Ahmedabad, Gujarat</p>
              <p className="text-gray-600 text-sm md:text-base">⏰ Available for freelance</p>
            </div>
          </div>

          {/* Column 3 */}
          <div>
            <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4 text-gray-900">Tech Stack</h3>
            <div className="flex flex-wrap gap-1 md:gap-2">
              {['React', 'JavaScript', 'Tailwind', 'CSS3', 'HTML5', 'Git', 'Figma'].map((tech) => (
                <span
                  key={tech}
                  className="px-2 md:px-3 py-1 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-full text-xs md:text-sm transition-colors duration-300"
                >
                  {tech}
                </span>
              ))}
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4 pt-6 md:pt-8 border-t border-gray-300">
          <div className="text-gray-600 text-xs md:text-sm flex items-center gap-2">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-8 text-sm text-gray-500">
          ...
          <a href="#resume" className="hover:text-purple-600 transition-colors">Resume</a>
