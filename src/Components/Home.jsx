...
const IconWrap = ({ children }) => (
  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-black rounded-full flex items-center justify-center
...
const Home = () => {
  return (
    <>
      ...
      <div className="w-full flex justify-center min-h-[calc(100vh-72px)]">
        ...
        <div className="container flex flex-col lg:flex-row my-5 sm:my-8 md:my-[50px] px-4 sm:px-8 md:px-12 lg:px-[150px]">
          ...
          <div className="w-full lg:w-1/2 order-2 lg:order-1">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold lg:font-normal text-black">
              Hi! I'm
            </h1>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold my-2 sm:my-3 text-purple-800">
              JITESH SOLANKI
            </h1>
            ...
            <div className="mt-6 sm:mt-8">
              <div className="flex flex-wrap gap-2 sm:gap-3 mb-2 sm:mb-3">
                <p className="px-3 py-1 text-sm sm:text-base border border-2 border-purple-800 rounded-full hover:shadow-[0_0_10px_rgba(220,38,38,0.9)] transition duration-300 whitespace-nowrap">
                  Frontend Developer
                </p>
                <p className="px-3 py-1 text-sm sm:text-base border border-2 border-purple-800 rounded-full hover:shadow-[0_0_10px_rgba(220,38,38,0.9)] transition duration-300 whitespace-nowrap">
                  React.js Developer
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-3 md:gap-6 mt-8 sm:mt-10">
              <div className="w-full sm:w-[180px] md:w-[220px] lg:w-[280px] h-[88px] bg-gray-200 rounded-2xl flex items-center px-4">
                <div>
                  <div className="flex items-center gap-2">
                    <MdLocationOn className="text-pink-500 text-[16px] sm:text-[18px]" />
                    <p className="text-xs sm:text-sm font-medium text-blue-500 leading-tight">
                      Location
                    </p>
                  </div>
                  <p className="text-xs sm:text-sm md:text-[15px] text-gray-800 mt-1">
              ...
              <div className="w-full sm:w-[180px] md:w-[220px] lg:w-[280px] h-[88px] bg-gray-200 rounded-2xl flex items-center px-4">
                <div>
                  ...
                  <p className="text-xs sm:text-sm md:text-[15px] text-gray-800 mt-1 break-all">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center w-full mt-6 sm:mt-8">
              <div className="w-full sm:w-auto">
                <p className="text-center sm:text-left text-sm font-medium mb-3 sm:mb-4">
                  Connect with me
                </p>
